    ...
    return (<Mainlayout className="MovieDetails">
        ...
        <section className="MovieDetails__info">  
            ...
            <div className="MovieDetails__info__FunctionInfo">
                ...
                <div>
                    <FunctionLink label="13:45" to="/movie/1/foo/seats"/>
                    <FunctionLink label="15:45" to="/movie/1/foo/seats"/>
                    <FunctionLink label="17:45" to="/movie/1/foo/seats"/>
                    <FunctionLink label="19:45" to="/movie/1/foo/seats"/>
                    <FunctionLink label="21:45" to="/movie/1/foo/seats"/>
                    <FunctionLink label="23:45" to="/movie/1/foo/seats"/>
                </div>
            </div>
        </section>
    </Mainlayout>)
